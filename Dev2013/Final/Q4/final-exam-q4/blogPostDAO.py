...
class BlogPostDAO:
	...
	# VAR changes : updating num_likes for the corresponding comment
        field = "comments.%d.num_likes" % (comment_ordinal)
	self.posts.update({'permalink': permalink}, {'$inc' : { field : 1}})
        return 0
